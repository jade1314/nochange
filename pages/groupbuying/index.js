...
Page({
  ...
  */
  addShopCar: function (e) {
    ...
    let goodsId = that.data.goodsDetail.basicInfo.id;
    if (!token) {
      that.goLoginPageTimeOut()
      return
    }
    wx.request({
      url: 'https://api.it120.cc/o0o/shop/goods/pingtuan/open',
      data: {
        token: token,
        goodsId: goodsId
  ...
  buliduBuyNowInfo: function () {
    ...
    shopCarMap.logistics = this.data.goodsDetail.logistics;
    shopCarMap.weight = this.data.goodsDetail.basicInfo.weight;
    shopCarMap.pintuanPrice = this.data.goodsDetail.basicInfo.pingtuanPrice;
    shopCarMap.pingtuan = true;
    var buyNowInfo = {};
